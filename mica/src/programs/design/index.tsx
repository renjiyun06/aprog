...
const SEED: ProcState[] = [
  {
    pid: 4102, name: 'acme · 官网重设计', dot: 'running', dir: '~/.aprog/4102',
    tree: acmeTree, events: acmeEvents, openFiles: [], viewFile: null, contents: acmeContents,
  },
  {
    pid: 4088, name: 'lumen · 移动端 onboarding', dot: 'running', dir: '~/.aprog/4088',
    tree: [
      { name: 'meta.yml', kind: 'file' },
      { name: 'input.md', kind: 'file' },
  ...
  {
    pid: 3971, name: 'fin dashboard', dot: 'hibernating', dir: '~/.aprog/3971',
    tree: [
      { name: 'meta.yml', kind: 'file' },
      { name: 'artifacts', kind: 'dir', children: [
  ...
  {
    pid: 3840, name: 'brandbook 提案', dot: 'running', dir: '~/.aprog/3840',
    tree: [
      { name: 'meta.yml', kind: 'file' },
      { name: 'input.md', kind: 'file' },
    ],
